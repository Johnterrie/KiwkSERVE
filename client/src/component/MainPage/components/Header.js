    ...
    <Carousel  className='y'>
      <Carousel.Item className='x'>
        ...
        <Carousel.Caption className='caro'>
          <h1 className='title'>Quality <span className='meet'>Meets</span> Service</h1>
      ...
      <Carousel.Item className='x'>
        ...
        <Carousel.Caption className='caro'>
          <h1 className='title'>Quality <span className='meet'>Meets</span> Service</h1>
          <p id='para'>At kwikserve we are determined in providing the 
          best service to meet your need at the quickest time.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
